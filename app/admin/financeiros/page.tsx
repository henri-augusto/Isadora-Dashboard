  ...
  return (
    <div>
      ...
      <div className="flex gap-4 mb-6">
        ...
        <button onClick={() => setShowForm(!showForm)} className="px-4 py-2 bg-jade-500 text-white rounded-lg hover:bg-jade-400">
      ...
      {showForm && (
        <form onSubmit={handleSubmit} className="bg-white p-4 rounded-lg shadow mb-6 space-y-4">
          ...
          <button type="submit" className="px-4 py-2 bg-jade-500 text-white rounded-lg">Salvar</button>
        </form>
      )}
      ...
      {summary && (
        <>
          <div className="grid grid-cols-3 gap-4 mb-6">
            ...
            <div className="bg-jade-50 border border-jade-200 rounded-lg p-4"><p className="text-sm text-jade-500">Saldo</p><p className="text-2xl font-bold text-jade-500">R$ {summary.balance.toFixed(2)}</p></div>
          </div>
